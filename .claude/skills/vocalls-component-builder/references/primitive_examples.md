...
reference and verified against [conventions.md](conventions.md),
...
[conventions.md §1.1–§1.5](conventions.md):
...
- **Used in**:
  - `__configJSON` values (whole-string or partial substitution —
    see [conventions.md §2.1](conventions.md)).
...
(geometry, ids, styles pinned in [conventions.md §1.6](conventions.md)):
...
[conventions.md §1.6](conventions.md).
