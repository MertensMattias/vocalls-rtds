...
**Canonical reference:** [voicemaildetector.js](../references/examples/voicemaildetector.js) — a 1804-line hand-authored composite that demonstrates every wiring pattern below.
...
See [voicemaildetector.js:17-41](../references/examples/voicemaildetector.js#L17-L41).
...
See [voicemaildetector.js:245-322](../references/examples/voicemaildetector.js#L245-L322) for the canonical shape.
...
See [voicemaildetector.js:670-756](../references/examples/voicemaildetector.js#L670-L756) for the canonical shape.
...
See [voicemaildetector.js:608-653](../references/examples/voicemaildetector.js#L608-L653) for the canonical shape (the GPT classifier).
...
Every edge is a bare `<mxCell edge="1">` at the baselayer. See [voicemaildetector.js:174-183](../references/examples/voicemaildetector.js#L174-L183) for one canonical form.
...
See [voicemaildetector.js:333-372](../references/examples/voicemaildetector.js#L333-L372) for the two label nodes (`picked by AI`, `regular voicemail`).
...
Every component exit is a `Type="transient"` node with `Kind="output"`. See [voicemaildetector.js:94-173](../references/examples/voicemaildetector.js#L94-L173) for the four exits (`voicemail`, `not exists`, `not available`, `call answered`).
...
The voicemaildetector embeds visual section headers as bare `<mxCell vertex="1">` elements with an HTML `value=` and a no-interaction style. See [voicemaildetector.js:210-218](../references/examples/voicemaildetector.js#L210-L218).
