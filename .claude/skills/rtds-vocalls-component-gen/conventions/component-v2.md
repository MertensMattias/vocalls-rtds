...
Patterns live in [.claude/skills/rtds-vocalls-component-gen/references/operation_bodies/](../references/operation_bodies/): `http_call.md`, `gui_exit.md`, `set_attributes.md`, `condition.md`, `flow_jump.md`, plus `composite.md` modifier. The work body:
