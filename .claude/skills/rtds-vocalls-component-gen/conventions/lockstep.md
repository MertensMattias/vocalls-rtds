...
For operations that have both a JS-handled twin in the runtime (e.g. `executeSetAttributes` in [rtds_2_runtime.js](../references/rtds_2_runtime.js)) **and** a Vocalls component on the canvas (e.g. [setAttributes.js](../references/examples/setAttributes.js)):
