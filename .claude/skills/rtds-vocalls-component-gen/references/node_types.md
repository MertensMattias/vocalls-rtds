...
10. **Edge anchor pattern depends on the visual relationship.** Pair an
    ...
    in production components (e.g. [voicemaildetector.js](examples/voicemaildetector.js)):
    ...
    overrides (see [component-v2.md §1](../conventions/component-v2.md)). Every other
...
- Style aliases and master-attribute order:
  [component-v2.md](../conventions/component-v2.md).
