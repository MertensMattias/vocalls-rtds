...
**Related files:**
- The live runtime helpers (`projects/demo/globalLibraries/active/rtds_globalCodeAndHelpers.js`) — implementation produced by this spec. See `runtime_pointer.md` in this directory.
