...
| scheduler | `http_call` (multi-branch, two-call: status → prompt resolve) | [spec](../specs/scheduler.spec.md) | ✅ [checkSchedule.js](../components/checkSchedule.js) | ⬜ not registered | ⬜ |
