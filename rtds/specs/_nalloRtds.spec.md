...
| Component name | n/a                                                                  |
| Pattern        | n/a                                                                  |
| Source handler | `rtds/pureconnect_handlers/NAllo_RTDS.xml`                  |
...
The Vocalls runtime owns this responsibility natively. The `Script-node entry points` in the runtime (per [runtime-spec.md §7](../docs/runtime-spec.md)) replace this handler entirely. Specifically:
