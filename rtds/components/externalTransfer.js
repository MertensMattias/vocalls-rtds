...
&#xa;__redirectStatus[__redirectTry] = "calling";'
    ...
    <object
      ...
      OnLeave=""
      DynamicNextId=""
      Code='redirectTry = redirectTry + 1;
&#xa;redirectStatus[redirectTry] = "calling";'
      MaxEntryNodeId=""
      MaxEntryCount=""
      DynamicNextTabGuid=""
      id="148"
    ...
    >
      <mxCell style="redirectNode" parent="baselayer" vertex="1">
        <mxGeometry x="868" y="560" width="160" height="120" as="geometry" />
      </mxCell>
    </object>
    <object id="121">
    ...
    <object
      ...
      OnLeave=""
      DynamicNextId=""
      Code='redirectStatus[redirectTry] = "executed";
&#xa;
