...
>
  <root>
    <object
      ...
      Variables='__configJSON = {&#xa;    "active": true,&#xa;    "configId": 1,&#xa;    "configName": "KLANTWACHT",&#xa;    "dialGuard": true,&#xa;    "outboundANI": "",&#xa;    "diversion": "",&#xa;    "onHoldAudioUrl": "https://vocalls.cz/downloads/files/CuRJXoaYDOPQbHZ8YAAQv_GENERAL_TENANT.wav",&#xa;    "timeout": 10000,&#xa;    "recordVoicemail": true,&#xa;    "acceptCallMenu": true,&#xa;    "acceptCallMessage": "Press 1 to accept the call.",&#xa;    "sendSms": true,&#xa;    "sendMail": true,&#xa;    "nextStep_Success": "00002",&#xa;    "nextStep_Failure": "00099",&#xa;    "nextStep": "00005"&#xa;};&#xa;__environment = environment;&#xa;__rtBaseUrl = _rtBaseUrl;&#xa;__rtGuardEndpoint = _rtActiveGuardByConfigEndpoint;&#xa;__rtOutcome = &#39;nextStep_Failure&#39;;&#xa;__rtNextStep &amp;= _rtNextStep;&#xa;// Loop accumulators only. Everything else is read live from __rtParams via&#xa;// getValue at its node, or is owned by a runtime node: getGuards seeds&#xa;// __guardIndex at 0 and appendLog increments it on failure; the guardLoop&#xa;// counter reads __guardIndex against __guardCount; the redirect owns&#xa;// __transferResult, the recognize owns __voicemailCapture;&#xa;// __guardList/__guardCount/__dialGuards/__recordVoicemail are set in getGuards;&#xa;// __guardLog must be seeded because appendLog pushes onto it;&#xa;// __guardPickedUp is the answered-case flag.&#xa;__guardLog = [];&#xa;__guardPickedUp = false;'
    ...
    <object label="rtds_1_globalConfig" id="323">
      <mxCell style="globalLibraryInnerNode;" vertex="1" parent="322">
    ...
    <object label="rtds_2_runtime" id="325">
      <mxCell style="globalLibraryInnerNode;" vertex="1" parent="324">
        <mxGeometry x="10" y="16" width="160" height="34" as="geometry" />
      </mxCell>
    </object>
    <object
    ...
    <object label="rtds_3_vocallsEnv" id="327">
      <mxCell style="globalLibraryInnerNode;" vertex="1" parent="326">
        <mxGeometry x="10" y="16" width="160" height="34" as="geometry" />
      </mxCell>
    </object>
    <object
    ...
    <object label="nalOktaAuth" id="329">
      <mxCell style="componentInnerNode" vertex="1" parent="328">
    ...
    <object
      ...
      id="330"
    >
      <mxCell style="component3OutputNode" vertex="1" parent="328">
    ...
    <object label="getEnvironment" id="333">
      <mxCell style="componentInnerNode" vertex="1" parent="332">
