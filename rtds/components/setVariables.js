...
>
  <root>
    <object
      ...
      Code="__rtParams = {};&#xa;&#xa;__getValue = function () {&#xa;    if (typeof getValue === &#39;undefined&#39;) {&#xa;        Logger.warn(&#39;[setVariables] shared function unavailable -- library not loaded&#39;, { fn: &#39;getValue&#39; });&#xa;        return undefined;&#xa;    }&#xa;    return getValue.apply(null, arguments);&#xa;};&#xa;&#xa;__activeFlag = function () {&#xa;    if (typeof activeFlag === &#39;undefined&#39;) {&#xa;        Logger.warn(&#39;[setVariables] shared function unavailable -- library not loaded&#39;, { fn: &#39;activeFlag&#39; });&#xa;        return undefined;&#xa;    }&#xa;    return activeFlag.apply(null, arguments);&#xa;};&#xa;&#xa;__extractParams = function () {&#xa;    if (typeof extractParams === &#39;undefined&#39;) {&#xa;        Logger.warn(&#39;[setVariables] shared function unavailable -- library not loaded&#39;, { fn: &#39;extractParams&#39; });&#xa;        return undefined;&#xa;    }&#xa;    return extractParams.apply(null, arguments);&#xa;};&#xa;&#xa;__setupConfig = function () {&#xa;    if (typeof setupConfig === &#39;undefined&#39;) {&#xa;        Logger.warn(&#39;[setVariables] shared function unavailable -- library not loaded&#39;, { fn: &#39;setupConfig&#39; });&#xa;        return undefined;&#xa;    }&#xa;    return setupConfig.apply(null, arguments);&#xa;};&#xa;&#xa;__walk = function () {&#xa;    if (typeof walk === &#39;undefined&#39;) {&#xa;        Logger.warn(&#39;[setVariables] shared function unavailable -- library not loaded&#39;, { fn: &#39;walk&#39; });&#xa;        return undefined;&#xa;    }&#xa;    return walk.apply(null, arguments);&#xa;};&#xa;&#xa;__setVariable = function () {&#xa;    if (typeof setVariable === &#39;undefined&#39;) {&#xa;        Logger.warn(&#39;[setVariables] shared function unavailable -- library not loaded&#39;, { fn: &#39;setVariable&#39; });&#xa;        return undefined;&#xa;    }&#xa;    return setVariable.apply(null, arguments);&#xa;};&#xa;"
      Extensions=""
