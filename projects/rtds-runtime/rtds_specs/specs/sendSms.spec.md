...
| Pattern        | `http_call`                                                 |
| Source handler | `rtds_pureconnect_handlers/handlers/NAllo_RTDS_SendSMS.xml` |
| Target file    | `rtds_vocalls_operations/components/sendSms.js` (already exists — this spec is the reference shape) |
