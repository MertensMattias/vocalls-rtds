...
| Source handler | `rtds_pureconnect_handlers/handlers/NAllo_RTDS_GuardTUI.xml`  |
| Target file    | `rtds_vocalls_operations/components/guardTui.js` (already exists — this spec is the reference shape) |
...
Multi-node component — see [`rtds_vocalls_operations/components/guardTui.js`](../components/guardTui.js).
