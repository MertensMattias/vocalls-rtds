...
| Source handler | `rtds_pureconnect_handlers/handlers/NAllo_RTDS_ManageCallCapacity.xml` |
| Target file    | `rtds_vocalls_operations/components/manageCallCapacity.js`             |
