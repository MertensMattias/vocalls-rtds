...
>
  <root>
    ...
    <object label="denied" SubType="expression" Expression="_rtNextStep == getValue(__rtParams, 'NextStep_Denied', -1)" DynamicNextId="" id="202">
      <mxCell style="expressionNode" parent="200" vertex="1">
        <mxGeometry x="10" y="56" width="140" height="30" as="geometry" />
      </mxCell>
    </object>
    <object label="failure" SubType="expression" Expression="_rtNextStep == getValue(__rtParams, 'NextStep_Failure', -1)" DynamicNextId="" id="203">
      <mxCell style="expressionNode" parent="200" vertex="1">
    ...
    <object label="success" SubType="expression" Expression="_rtNextStep == getValue(__rtParams, 'NextStep_Success', -1)" DynamicNextId="" id="452">
      <mxCell style="expressionNode" parent="450" vertex="1">
        <mxGeometry x="10" y="56" width="140" height="30" as="geometry" />
      </mxCell>
    </object>
    <object label="onlyActive" SubType="expression" Expression="_rtNextStep == getValue(__rtParams, 'NextStep', -1)" DynamicNextId="" id="453">
      <mxCell style="expressionNode" parent="450" vertex="1">
        <mxGeometry x="10" y="86" width="140" height="30" as="geometry" />
      </mxCell>
    </object>
    ...
    <object label="success" SubType="expression" Expression="_rtNextStep == getValue(__rtParams, 'NextStep_Success', -1)" DynamicNextId="" id="552">
