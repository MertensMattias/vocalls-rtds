...
The Vocalls env library [rtds_3_vocallsEnv.js](../projects/rtds-runtime/globalLibraries/active/rtds_3_vocallsEnv.js) is the source of truth for cross-cutting helpers. Public surface (declared without `var`/`let`/`const` so they land on the global scope):
